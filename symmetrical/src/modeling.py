"""
Modeling Module (Bilateral): Defines the CNN-LSTM Hybrid Architecture.
---------------------------
...
def build_model(input_shape: tuple) -> models.Model:
    model = models.Sequential([
        # 1. Physics Kernel (12 Channels Input): Increased filters 64->96 to handle bilateral correlations
...
def run_modeling_pipeline():
    ...
    # CONFIGURATION FOR 100% ET RECALL: Weight 6.0: The "Sweet Spot" that balances signal vs noise.
