# Exploration Module: Audits the data quality (Bilateral Compatible).
...
def plot_spectral_density(paths: Paths):
    ...
    # Calculate magnitude of Watch A (Cols 0,1,2). If we wanted Watch B, we would use [:, :, 6:9]
    ...
    plt.legend()
    plt.grid(alpha=0.3)
    plt.savefig(paths.reports / "spectral_audit.png")
    plt.close()
